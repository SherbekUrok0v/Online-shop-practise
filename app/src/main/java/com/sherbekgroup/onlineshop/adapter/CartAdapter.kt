...
import kotlinx.android.synthetic.main.product_item_layout.view.tv_prod_price

class CartAdapter(val items: List<ProductModel>) :
    ...
    inner class ItemHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun onBind(productModel: ProductModel) {
            itemView.apply {
                ...
                tv_count.text = productModel.cartCount.toString()
            }
        }
    }
